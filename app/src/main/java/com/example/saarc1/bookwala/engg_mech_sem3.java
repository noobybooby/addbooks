...
public class engg_mech_sem3 extends AppCompatActivity {
    ...
    DatabaseReference databaseBooks1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addbook_mech);


        databaseBooks1 = firebaseDatabase.getInstance().getReference().child("book").child("Engineering").child("branch").child("mech");
        ...
        addBtn = (Button) findViewById(R.id.addBtnMech3);
    ...
    private void addBook(){
        ...
        if (mImageUri != null && TextUtils.isEmpty(name)) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    String id = databaseBooks1.push().getKey();
                                    Book book = new Book(id,name,price,author,imageUrl.toString());

                                    databaseBooks1.child(id).setValue(book);

                                    Toast.makeText(engg_mech_sem3.this, "upload hogayi", Toast.LENGTH_LONG).show();
                                }
                            });
            ...
            Toast.makeText(engg_mech_sem3.this, "Nai hua Upload, Aur ek baar karo ", Toast.LENGTH_LONG).show();
        }
