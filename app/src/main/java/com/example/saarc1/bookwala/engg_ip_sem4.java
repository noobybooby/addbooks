...
public class engg_ip_sem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseBooks = FirebaseDatabase.getInstance().getReference("book").child("Engineering").child("branch").child("IP").child("sem4");
    ...
    private void addBook(){
        ...
        if (mImageUri != null && TextUtils.isEmpty(name)) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(engg_ip_sem4.this, "upload hogayi", Toast.LENGTH_LONG).show();
                                }
                            });
            ...
            Toast.makeText(engg_ip_sem4.this, "Nai hua Upload, Aur ek baar karo ", Toast.LENGTH_LONG).show();
        }
